...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="guardar_compra.php" method="post" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="variante_id" name="variante_id" required>
                        ...
                        while($va=$vars->fetch_assoc()){
                            echo '<option value="'.$va['id'].'">'.htmlspecialchars($va['producto']).' - '.htmlspecialchars($va['sku']).'</option>';
                        }
                        ?>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="proveedor_id" name="proveedor_id" required>
                        ...
                        while($pr=$prov->fetch_assoc()){
                            echo '<option value="'.$pr['id'].'">'.htmlspecialchars($pr['nombre_empresa']).'</option>';
                        }
                        ?>
                    </select>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="precio_unitario" name="precio_unitario" step="0.01" min="0" required placeholder="0.00" onkeydown="return event.keyCode !== 69">
                        <div class="invalid-feedback">Ingrese un precio válido (use punto para decimales).</div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="cantidad" class="form-label">Cantidad:</label>
                        <input type="number" class="form-control" id="cantidad" name="cantidad" value="1" min="1" step="1" required onkeydown="return event.keyCode !== 69">
                        <div class="invalid-feedback">La cantidad debe ser al menos 1.</div>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="fecha_compra" class="form-label">Fecha Compra (opcional):</label>
                    <input type="datetime-local" class="form-control" id="fecha_compra" name="fecha_compra" max="<?php echo date('Y-m-d\TH:i'); ?>">
