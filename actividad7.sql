...
--
-- Host: localhost:3307
-- Generation Time: Jan 04, 2026 at 03:00 PM
...
CREATE TABLE `usuarios` (
  ...
  `clave` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `rol_id` int DEFAULT NULL,
  `pregunta_1_id` int DEFAULT NULL,
  `respuesta_1` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pregunta_2_id` int DEFAULT NULL,
  `respuesta_2` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pregunta_3_id` int DEFAULT NULL,
  `respuesta_3` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` enum('pendiente_activacion','activo','inactivo') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pendiente_activacion',
  `token_otp` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
